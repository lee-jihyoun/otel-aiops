...
# 경로 설정
log_file_path = "./data/adServiceHighCpu/original_logs.json"
span_file_path = "./data/adServiceHighCpu/original_span.json"

output_path = './data/adServiceHighCpu/output/'
log_output_path = './data/adServiceHighCpu/output/original_logs.json'
span_output_path = './data/adServiceHighCpu/output/original_span.json'
                        ...
                        if span.get("traceId") in trace_ids:
                            ...
                            for attribute in span.get("attributes", []):
                                if attribute["key"] == "http.status_code":
                                    parsed_info["http.status_code"] = attribute["value"]
